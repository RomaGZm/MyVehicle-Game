...
public class TurretAimPlane : MonoBehaviour
{
    ...
    public Transform planeOrigin;   // точка перед машиной
    public float planeOffset = 20f; // вперед от машины
    public Camera cam;
    ...
    private void OnDrawGizmos()
    {
        ...
        Vector3 size = new Vector3(20, 0, 20); // ширина, высота = 0, глубина
